...
A C++20 numerical library in which twelve iterative solvers are written once,
...
row; and two reports built from the measurements by script.
...
\begin{enumerate}
  ...
  \item \textbf{Sequential methods do not parallelise, and saying so is more
        ...
        at a measured cost of \pnlRedBlackPenalty{} percent more iterations on a
        \pnlRedBlackGrid{} grid.
